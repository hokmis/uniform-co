  ...
  return (
    <section className="panel" aria-label="庫存管理操作入口">
      ...
      <div className="summary-list">
        <div className="summary-row"><span><strong>期初庫存</strong><small>免 Worker 即時匯入；由瀏覽器直接預覽後一次發布。</small></span><button className="secondary-button" type="button" onClick={() => onOpenOpeningImport?.()}>前往期初匯入</button></div>
