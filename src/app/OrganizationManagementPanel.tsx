    ...
    <ModuleWorkbench
      ...
      actions={screen === "EDITOR"
        ...
        : <>
          ...
          <button className="secondary-button" type="button" onClick={() => createEntity("DEPARTMENTS")}>＋ 新增報局單位</button>
          ...
          content: <div className="workspace-panel-grid workspace-panel-grid--balanced organization-import-grid">
            ...
            <section className="panel organization-boundary-card" aria-label="組織主檔管理說明">
              ...
              <div className="summary-list">
                <div className="summary-row"><span><strong>穩定代碼</strong><small>修改模式不變更課室部門／報局單位代碼，避免誤建立另一筆主檔或破壞外部對照。</small></span></div>
                <div className="summary-row"><span><strong>獨立維護</strong><small>報局單位可獨立建立與維護，無需綁定課室部門。</small></span></div>
