-- Make pgcrypto digest() available to existing SECURITY DEFINER RPCs.
-- Those RPCs intentionally use `pg_catalog, private` as their search_path;
-- Supabase projects can install pgcrypto in either public or extensions.
